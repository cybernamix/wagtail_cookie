# flake8: noqa
"""
Django settings for wagtail_cookie project.
...
DJANGO_ROOT = root.path('wagtail_cookie')
...
WSGI_APPLICATION = 'wagtail_cookie.wsgi.application'
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///wagtail_cookie'),
}
...
WAGTAIL_SITE_NAME = "wagtail_cookie"
